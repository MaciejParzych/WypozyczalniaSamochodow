...
public class MainWindowTable extends JFrame {
    ...
    private JButton getDownButton() {
        if (this.downButton == null) {
            ...
            this.downButton.setIcon(new ImageIcon(getClass().getResource("/WypozyczalniaSamochodow/gui/down.png")));
    ...
    private JButton getDeleteButton() {
        if (this.deleteButton == null) {
            ...
            this.deleteButton.setIcon(new ImageIcon(getClass().getResource("/WypozyczalniaSamochodow/gui/bin.png")));
    ...
    private JButton getUpButton() {
        if (this.upButton == null) {
            ...
            this.upButton.setIcon(new ImageIcon(getClass().getResource("/WypozyczalniaSamochodow/gui/up.png")));
...
//			this.addTaskButton.setIcon(new ImageIcon(getClass().getResource("/es/uvigo/esei/dojos/swing/todo/gui/diary.png")));
            this.addTaskButton.setIcon(new ImageIcon(getClass().getResource("/resources/car2.png")));
//			this.addTaskButton.setIcon(new ImageIcon(getClass().getResource("car2.png")));
